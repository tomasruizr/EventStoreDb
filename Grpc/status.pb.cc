...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_status_2eproto = {
  false, false, descriptor_table_protodef_status_2eproto, "status.proto", 270,
  &descriptor_table_status_2eproto_once, descriptor_table_status_2eproto_sccs, descriptor_table_status_2eproto_deps, 1, 2,
...
void Status::InitAsDefaultInstance() {
  ::google::rpc::_Status_default_instance_._instance.get_mutable()->details_ = const_cast< PROTOBUF_NAMESPACE_ID::Any*>(
      PROTOBUF_NAMESPACE_ID::Any::internal_default_instance());
}
class Status::_Internal {
 public:
  static const PROTOBUF_NAMESPACE_ID::Any& details(const Status* msg);
};
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          _internal_set_code(static_cast<::google::rpc::Code>(val));
...
void Status::InternalSwap(Status* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      ...
      + sizeof(Status::code_)
      - PROTOBUF_FIELD_OFFSET(Status, details_)>(
